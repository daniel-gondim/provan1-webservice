...
public class InvestimentoService implements IService<Investimento, Integer> {
    ...
    public Investimento readById(Integer id) throws Exception {
        ...
        log.debug(String.format("Método InvestimentoService.readById executado com o objeto: %s", id));
        return null;
    }
    ...
    public Investimento deleteById(Integer id) {
        ...
        log.debug(String.format("Método InvestimentoService.delete executado com o objeto: %s", id));
        return null;
    }

...
public class TipoInvestimentoService implements IService<TipoInvestimento, Integer> {
    ...
    public TipoInvestimento readById(Integer id) throws Exception {
        ...
        log.debug(String.format("Método TipoInvestimentoService.readById executado com o objeto: %s", id));
        return null;
    }
    ...
    public TipoInvestimento deleteById(Integer id) {
        ...
        log.debug(String.format("Método TipoInvestimentoService.create executado com o objeto: %d", id));
        return null;
    }
